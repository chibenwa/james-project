...
public class JmxServerProbe implements ServerProbe {
    ...
    private final static String SIEVEMANAGER_OBJECT_NAME = "org.apache.james:type=component,name=quotamanagerbean";
    private final static String QUOTAMANAGER_OBJECT_NAME = "org.apache.james:type=component,name=sievemanagerbean";
