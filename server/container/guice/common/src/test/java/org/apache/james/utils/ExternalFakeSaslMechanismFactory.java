...
/**
 * Test factory outside James' default SASL package to validate fully qualified class name resolution.
 */
public class ExternalFakeSaslMechanismFactory implements SaslMechanismFactory {
    ...
    public SaslMechanism create(HierarchicalConfiguration<ImmutableNode> serverConfiguration) {
        return new ExternalFakeSaslMechanism();
    }

    public static class ExternalFakeSaslMechanism implements SaslMechanism {
        @Override
        public String name() {
