...
public class NoLWTCassandraUidProvider extends CassandraUidProvider {
    @Inject
    public NoLWTCassandraUidProvider(Session session, CassandraConfiguration cassandraConfiguration,
