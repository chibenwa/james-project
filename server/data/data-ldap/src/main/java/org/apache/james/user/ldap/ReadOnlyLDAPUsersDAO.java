...
public class ReadOnlyLDAPUsersDAO implements UsersDAO, Configurable {
    ...
    public void init() throws Exception {
        ...
        ldapConnection = new LDAPConnection(uri.getHost(), uri.getPort(), ldapConfiguration.getPrincipal(), ldapConfiguration.getCredentials());
    ...
    private Set<String> getAllUsersFromLDAP() throws LDAPException {
        ...
        try {
            com.unboundid.ldap.sdk.SearchResult searchResult = connection.search(ldapConfiguration.getUserBase(),
                SearchScope.SUB,
                filterTemplate);
