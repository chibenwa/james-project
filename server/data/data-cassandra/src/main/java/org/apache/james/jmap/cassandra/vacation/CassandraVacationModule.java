        ...
        tables = ImmutableList.of(
            new CassandraTable(CassandraVacationTable.TABLE_NAME,
                SchemaBuilder.createTable(CassandraVacationTable.TABLE_NAME)
                    ...
                    .addColumn(CassandraVacationTable.FROM_DATE, timestamp())
                    .addColumn(CassandraVacationTable.FROM_TIMEZONE, text())
                    .addColumn(CassandraVacationTable.TO_DATE, timestamp())
                    .addColumn(CassandraVacationTable.TO_TIMEZONE, text())
