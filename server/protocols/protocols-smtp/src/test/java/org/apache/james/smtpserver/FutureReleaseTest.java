...
class FutureReleaseTest {
    ...
    void mailShouldBeRejectedWhenMaxFutureReleaseDateTime() throws Exception {
        ...
        smtpProtocol.sendCommand("MAIL FROM: <bob@localhost> HOLDUNTIL=2023-04-15T11:00:00-08:00");
        SoftAssertions.assertSoftly(softly -> {
            softly.assertThat(smtpProtocol.getReplyCode()).isEqualTo(554);
            softly.assertThat(smtpProtocol.getReplyString()).contains("554 Email rejected");
        });
    ...
    void mailShouldBeRejectedWhenHoldUntilBeforeNow() throws Exception {
        ...
        smtpProtocol.sendCommand("MAIL FROM: <bob@localhost> HOLDUNTIL=2023-04-13T11:00:00+07:00");
        SoftAssertions.assertSoftly(softly -> {
            softly.assertThat(smtpProtocol.getReplyCode()).isEqualTo(554);
            softly.assertThat(smtpProtocol.getReplyString()).contains("554 Email rejected");
        });
