...
public class JmapResponse {
    ...
    public static class Builder {
        ...
        private Optional<Pair<Integer, SimpleFilterProvider>> filterProvider = Optional.empty();
        ...
        public Builder filterProvider(Optional<Pair<Integer, SimpleFilterProvider>> filterProvider) {
    ...
    private final Optional<Pair<Integer, SimpleFilterProvider>> filterProvider;
    
    private JmapResponse(Method.Response.Name method, MethodCallId methodCallId, Method.Response response, Optional<? extends Set<? extends Property>> properties, Optional<Pair<Integer, SimpleFilterProvider>> filterProvider) {
        this.method = method;
        this.methodCallId = methodCallId;
        this.response = response;
    ...
    public Optional<Pair<Integer, SimpleFilterProvider>> getFilterProvider() {
