...
import org.apache.james.eventsourcing.{ReactiveSubscriber, Subscriber}
...
class MemoryTaskExecutionDetailsProjection() extends TaskExecutionDetailsProjection {
  ...
  private[this] val details: ConcurrentHashMap[TaskId, TaskExecutionDetails] = new ConcurrentHashMap[TaskId, TaskExecutionDetails]
