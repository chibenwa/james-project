...
public class Main {
    private static final String PREFIX = "folder-k-";
    private static final Random RANDOM = new Random();
    private static final String URL = "imaps://172.25.0.2:993";
    private static int NUM_MBX = 10;
    private static int NUM_MSG_REGULAR_FOLDER = 50;
    private static int NUM_MSG_INBOX = 200;
    ...
    public static void main(String... args) throws Exception {
        // TODO get this from CSV, with limit, offset
        String user = "bob@localhost";
        ...
        connect(imapClient, serverUri)

            // LOGIN
            .flatMap(session -> execute(session.getSession(), new LoginCommand(user, password))
